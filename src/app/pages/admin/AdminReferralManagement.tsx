...
import CommissionWithdrawalManagement from './components/CommissionWithdrawalManagement';

const AdminReferralManagement: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'referrals' | 'withdrawals'>('referrals'); // ✅ Tab State
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Pengelolaan data Influencer, BA, Affiliator, dan Pencairan Profit
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4 mb-8 border-b border-gray-200 pb-1">
            <button
              ...
              className={`pb-3 px-4 text-sm font-medium transition-colors relative ${activeTab === 'referrals'
            ...
            <button
              ...
              className={`pb-3 px-4 text-sm font-medium transition-colors relative ${activeTab === 'withdrawals'
                ? 'text-[#D4AF37] border-b-2 border-[#D4AF37]'
                : 'text-gray-500 hover:text-gray-700'
                }`}
            >
        ...
        {/* Referral Management Content (Existing) */}
        {activeTab === 'referrals' && (
          <>
            {/* Stats Grid */}
                ...
                <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-200">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm font-medium text-blue-700 mb-1">Total Partner Aktif</p>
                        <p className="text-4xl font-bold text-blue-900">{stats.totalAlumni}</p>
                        <p className="text-xs text-blue-600 mt-1">BA / Influencer / Affiliator</p>
                      </div>
              ...
              <CardContent className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="md:col-span-2">
                    <Label className="mb-2 block">Cari BA / Influencer</Label>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  Daftar BA, Affiliator, Influencer & Profit ({filteredReferrals.length})
                </CardTitle>
              </CardHeader>
              <CardContent>
                {loading ? (
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="border-b-2 border-gray-200">
                          <th className="text-left py-4 px-4 font-semibold text-gray-700">BA / Influencer</th>
