...
const AffiliatorDashboardNew: React.FC = () => {
                        ...
                        <div className="flex items-center justify-between gap-2">
                            <div className="flex items-center gap-2 sm:gap-4">
                                ...
                                <div className="flex flex-col justify-center">
                                    ...
                                    <p className="text-white/90 text-[10px] sm:text-sm mt-0.5 sm:mt-1 drop-shadow-md line-clamp-1">
                            ...
                            <div className="flex items-center gap-1 sm:gap-3 flex-shrink-0">
                                <AgentNotificationBell
                                    ...
                                    className="text-white hover:bg-white/20 rounded-full w-9 h-9 sm:w-10 sm:h-10"
                                />
                                <Button
                                    variant="ghost"
                                    size="icon"
                    ...
                    <div className="grid grid-cols-3 gap-2 sm:gap-4 md:gap-6 mb-6 sm:mb-8">
                        ...
                        <motion.div
                            ...
                            <Card className="relative overflow-hidden border border-white/20 shadow-2xl bg-white/10 backdrop-blur-xl text-white">
                                ...
                                <CardContent className="p-2 sm:p-4 md:p-6 relative z-10 flex flex-col justify-between h-full min-h-[110px] sm:min-h-[140px]">
                                    <div className="flex items-start justify-between">
                                        <div className="w-8 h-8 sm:w-10 sm:h-12 bg-white/20 rounded-lg sm:rounded-xl flex items-center justify-center backdrop-blur-sm">
                            ...
                            <Card className="relative overflow-hidden border border-white/20 shadow-2xl bg-white/10 backdrop-blur-xl text-white">
                                ...
                                <CardContent className="p-2 sm:p-4 md:p-6 relative z-10 flex flex-col justify-between h-full min-h-[110px] sm:min-h-[140px]">
                                    <div className="flex items-start justify-between">
                                        ...
                                        <DollarSign className="w-3 h-3 sm:w-4 sm:h-5 text-white/70" />
                                    </div>
                                    <div>
                                        <p className="text-green-100 text-[10px] sm:text-xs md:text-sm font-medium leading-tight">Total Saldo</p>
                                        <p className="text-base sm:text-2xl md:text-3xl font-bold mt-0.5 whitespace-nowrap overflow-hidden text-ellipsis">Rp {stats.approvedCommission.toLocaleString('id-ID')}</p>
                                        <p className="text-green-100 text-[8px] sm:text-[10px] md:text-xs mt-0.5 line-clamp-1">Siap cair</p>
                                    </div>
                                </CardContent>
                            </Card>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            <Card className="relative overflow-hidden border border-white/20 shadow-2xl bg-white/10 backdrop-blur-xl text-white">
                                ...
                                <CardContent className="p-2 sm:p-4 md:p-6 relative z-10 flex flex-col justify-between h-full min-h-[110px] sm:min-h-[140px]">
                                    <div className="flex items-start justify-between">
                                        <div className="w-8 h-8 sm:w-10 sm:h-12 bg-white/20 rounded-lg sm:rounded-xl flex items-center justify-center backdrop-blur-sm">
                                            <Clock className="w-4 h-4 sm:w-5 sm:h-6" />
                                        </div>
                                        <Award className="w-3 h-3 sm:w-4 sm:h-5 text-white/70" />
                                    </div>
                                    <div>
                                        <p className="text-yellow-100 text-[10px] sm:text-xs md:text-sm font-medium leading-tight">Profit Ok</p>
                                        <p className="text-base sm:text-2xl md:text-3xl font-bold mt-0.5 whitespace-nowrap overflow-hidden text-ellipsis">Rp {stats.withdrawnCommission.toLocaleString('id-ID')}</p>
                                        <p className="text-yellow-100 text-[8px] sm:text-[10px] md:text-xs mt-0.5 line-clamp-1">Sudah bayar</p>
                                    </div>
                                </CardContent>
                            </Card>
                        </motion.div>
                    ...
                    <Tabs defaultValue="referral" className="space-y-6">
                        <TabsList className="bg-white/10 backdrop-blur-xl shadow-2xl border border-white/20 p-1 sm:p-1.5 rounded-2xl flex justify-center">
                            ...
                            <TabsTrigger
                                ...
                                <span className="whitespace-nowrap">Pencairan Profit</span>
                            </TabsTrigger>
                        </TabsList>
                                    ...
                                    <div className="p-4 sm:p-6 md:p-8 bg-gradient-to-br from-gray-50 to-white rounded-b-2xl">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                            ...
                                            <div className="flex items-start gap-3 bg-white/90 backdrop-blur-sm p-4 rounded-xl shadow-sm border border-gray-200">
                                                ...
                                                <div>
                                                    <p className="font-semibold text-gray-900 mb-1">Cairkan Profit</p>
                                                    <p className="text-sm text-gray-600">Ajukan pencairan untuk profit yang sudah disetujui</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <Card className="border-0 shadow-xl">
                                    <div className="bg-gradient-to-r from-green-500 to-emerald-600 p-6">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <h2 className="text-2xl font-bold text-white">Pencairan Profit</h2>
                                                <p className="text-green-100">Cairkan profit yang sudah disetujui</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="p-8">
                                        ...
                                        <div className="bg-white rounded-2xl border-2 border-gray-200">
                                            <div className="p-6 border-b border-gray-200">
                                                ...
                                                <p className="text-sm text-gray-600 mt-1">Status dan detail pengajuan pencairan profit Anda</p>
                                            </div>
                                            ...
                                            <div className="p-6">
                                                {withdrawalRequests.length === 0 ? (
                                                    <div className="text-center py-12">
                                                        ...
                                                        <p className="text-sm text-gray-400 mt-2">Klik tombol "Ajukan Pencairan Profit" untuk memulai</p>
                                                    </div>
                                                ) : (
...
export default AffiliatorDashboardNew;
