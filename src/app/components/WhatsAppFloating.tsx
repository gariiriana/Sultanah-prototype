  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`absolute right-full mr-4 top-1/2 -translate-y-1/2 whitespace-nowrap transition-all duration-300 hidden sm:block ${isHovered ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-4 pointer-events-none'
            }`}
        >
        ...
        <div className="relative group">
          ...
          >
            <div className="bg-gradient-to-br from-green-400 via-green-500 to-green-600 rounded-full p-0.5 sm:p-1 shadow-lg">
              {/* WhatsApp icon as inline SVG */}
              <svg
                viewBox="0 0 24 24"
                fill="white"
                className="w-10 h-10 sm:w-14 sm:h-14 transition-transform duration-300 group-hover:rotate-12"
              >
          ...
          {/* Pulse Indicator */}
          <div className="absolute -top-1 -right-1 w-3 h-3 sm:w-4 sm:h-4 bg-red-500 rounded-full border-2 border-white animate-pulse shadow-lg"></div>
        </div>
      </a>
    </>
  );
